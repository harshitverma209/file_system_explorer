...
Future<String> showPicker(BuildContext context,
    {Widget topInfo, FlutterFileType searchFor}) {
  return showDialog(
      context: context,
      builder: (context) {
        return Dialog(
...
class FilePickerDialog extends StatelessWidget {
  ...
  const FilePickerDialog({Key key, this.topInfo, this.searchFor})
      : super(key: key);
...
class FilePicker extends StatelessWidget {
  FilePicker({Key key, this.onPathSelected, this.searchFor})
      : __currentFileSystemEntitiy = _CurrentFileSystemEntitiy(searchFor),
        super(key: key);
